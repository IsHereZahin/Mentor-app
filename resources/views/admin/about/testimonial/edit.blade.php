                    ...
                    <form class="form-horizontal" action="{{ route('dashboard.testimonial.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="comment" value="{{ $testimonial->comment }}" ></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="image" value="{{ $testimonial->image }}" class="form-control" required >
                                </div>
                            </div>
